...
public class ThreadLock extends Thread {
    ...
    public ThreadLock(Lock lock1, Lock lock2, CyclicBarrier barrier, int minActivity1, int maxActivity1, int minActivity2, int maxActivity2, int transitionTime, String name) {
        this.lock1 = lock1;
        this.lock2 = lock2;
